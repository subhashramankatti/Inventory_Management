...
ALLOWED_CLASSES = ['apple', 'banana', 'bottle', 'knife', 'chair','toothbrush','book', 'orange', 'mouse']
...
# Function to update stock in the 'items' collection
...
def process_frame(frame, model, items_collection, basket_id, basket_no, detected_items):
    ...
    if len(detections) > 0:
        for _, row in detections.iterrows():
            ...
            if item_in_db:
                # Update the stock of the detected item
